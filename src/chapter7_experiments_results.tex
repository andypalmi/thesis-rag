...
The retrieval performance of the five embedding models across the six datasets is presented in detail in Tables~ef{tab:detailed_recall} through~ef{tab:detailed_nDCG}, with an aggregated summary provided in Table~ef{tab:summary}. The results not only underscore a clear superior performer within our long-context benchmark but also indicate a significant paradigm shift in the broader landscape of text embedding models.
