...
%–– vertically center and horizontally expand the table ––%
\par\vspace*{\fill}
\noindent\makebox[\textwidth][c]{%
  \begin{minipage}{\dimexpr\textwidth+6cm\relax} % <- expand width by 2cm total
    \centering
    \small
    ...
    \begin{longtable}{|l|c|cccccc|c|cccccc|c|}
      ...
      & & 2wiki & narrative & needle & passkey & qmsum & summ & \textbf{Avg}
        & 2wiki & narrative & needle & passkey & qmsum & summ & \textbf{Avg} \\
      \midrule
      \endfirsthead
      \multicolumn{14}{c}{\tablename\ \thetable{} -- continued from previous page} \\
      \midrule
      \textbf{Model} & \textbf{k} & 2wiki & narrative & needle & passkey & qmsum & summ
        & 2wiki & narrative & needle & passkey & qmsum & summ \\
      \midrule
      \endhead
      \midrule
